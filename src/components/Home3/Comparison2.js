  ...
  return (
    <section className="comparision">
            <div className="comparision__shape-1 float-bob-y">
                <img src={require("../../assets/images/shapes/comparision-shape-1.png")} alt="img" />
            </div>
            <div className="comparision__shape-2 float-bob-y">
                <img src={require("../../assets/images/shapes/comparision-shape-2.png")} alt="img" />
            </div>
            <div className="comparision__shape-3 float-bob-x">
                <img src={require("../../assets/images/shapes/comparision-shape-3.png")} alt="img" />
            </div>
            <div className="container">
                <div className="comparision__section-title text-center">
                    <h2 className="comparision__section-title__title">Hostup community based of <br /> 2350+ hosting providers
                    </h2>
                    <p className="comparision__section-title__text">The distracted by the readable content of a page when
                    ...
                    <div className="comparision__inner tabs-box text-center">
                        ...
                        <div className="tabs-content">
                            ...
                            <div className="tab active-tab" id="reliability">
                                <div className="comparision__tab-content-box">
                                    <div className="comparision__tab-content-img">
                                        <canvas className="bar-chart" id="bar-chart-1" data-chart-options='{
											"type": "bar",
											"data": {
                            ...
                            <div className="tab" id="pricings">
                                <div className="comparision__tab-content-box">
                                    <div className="comparision__tab-content-img">
                                        <canvas className="bar-chart" id="bar-chart-2" data-chart-options='{
											"type": "bar",
											"data": {
											  "labels": ["Hostup", "Fenco", "Melpe", "Paese", "Metrow", "Halsey", "Mili"],
											  "datasets": [
                            ...
                            <div className="tab" id="friendly">
                                <div className="comparision__tab-content-box">
                                    <div className="comparision__tab-content-img">
                                        <canvas className="bar-chart" id="bar-chart-3" data-chart-options='{
											"type": "bar",
											"data": {
											  "labels": ["Hostup", "Fenco", "Melpe", "Paese", "Metrow", "Halsey", "Mili"],
											  "datasets": [
                            ...
                            <div className="tab" id="support">
                                <div className="comparision__tab-content-box">
                                    <div className="comparision__tab-content-img">
                                        <canvas className="bar-chart" id="bar-chart-4" data-chart-options='{
											"type": "bar",
											"data": {
											  "labels": ["Hostup", "Fenco", "Melpe", "Paese", "Metrow", "Halsey", "Mili"],
											  "datasets": [
                            ...
                            <div className="tab" id="features">
                                <div className="comparision__tab-content-box">
                                    <div className="comparision__tab-content-img">
                                        <canvas className="bar-chart" id="bar-chart-5" data-chart-options='{
											"type": "bar",
											"data": {
											  "labels": ["Hostup", "Fenco", "Melpe", "Paese", "Metrow", "Halsey", "Mili"],
											  "datasets": [
