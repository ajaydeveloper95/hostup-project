...
import TestBackgroundFour from "../../assets/images/background/testimonial-four-bg.jpg";
import LogoPng from "../../assets/images/resources/testimonial-logo.png";
  ...
  return (
    <section className="testimonial-four">
      <div
        ...
        style={{
          backgroundImage: `url(${TestBackgroundFour})`,
        }}
      />
