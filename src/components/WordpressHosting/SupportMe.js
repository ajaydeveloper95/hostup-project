...
import supportOneShape1 from "../../assets/images/shapes/support-one-shape-1.png";
import SupportOneImg1 from "../../assets/images/resources/support-one-img-1.png";
  ...
  return (
    <section className="support-one">
      <div
        ...
        style={{
          backgroundImage: `url(${supportOneShape1})`,
        }}
      />
      <div className="support-one__img float-bob-x">
        <img src={SupportOneImg1} alt="img" />
      </div>
