        ...
        <div className="mobile-nav__container">
          <ul className="mobile-menu__list">
            <li className="menu-item-has-children">
              <Link onClick={() => sethomedd(!homedd)} to="#">
                Home
              ...
              {homedd && (
                <ul className="d-block">
                  ...
                  <li className="menu-item-has-children">
                    <Link to="/" onClick={() => setheaderdd(!headerdd)}>
                      Header Styles
                      <button aria-label="dropdown toggler">
                        <i className="fa fa-angle-down"></i>
                      </button>
                    ...
                    {headerdd && (
                      <ul className="d-block">
                        ...
                        <li>
                          <Link to="/home4">Header Four</Link>
                        </li>
                      </ul>
                    )}
                  </li>
            ...
            <li className="menu-item-has-children">
              <Link onClick={() => sethostingdd(!hostingdd)} to="#">
                Hosting
                <button aria-label="dropdown toggler">
                  <i className="fa fa-angle-down"></i>
                </button>
            ...
            <li className="menu-item-has-children megamenu">
              <Link onClick={() => setdomaindd(!domaindd)} to="#">
                Domain
                <button aria-label="dropdown toggler">
                  <i className="fa fa-angle-down"></i>
                </button>
            ...
            <li className="menu-item-has-children">
              <Link onClick={() => setpagesdd(!pagesdd)} to="#">
                Pages
                <button aria-label="dropdown toggler">
                  <i className="fa fa-angle-down"></i>
                </button>
