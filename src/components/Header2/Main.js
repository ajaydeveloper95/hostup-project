...
const Header2 = () => {
  return (
    <header className="main-header-one main-header-two">
                ...
                <div className="container">
                    <div className="main-header-two__inner">
                        <div className="main-header-two__call">
                            ...
                            <p className="main-header-two__call-number">Helpline Call - <Link to="/tel:180090201000">(+1) 800
                                    9020 1000</Link></p>
                        </div>
            ...
            <div className="main-header-two__nav-box sticky-header">
                <div className="container">
